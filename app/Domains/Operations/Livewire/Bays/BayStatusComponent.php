...
namespace App\Domains\Operations\Livewire\Bays;
...
class BayStatusComponent extends Component
{
    ...
    public function editWashBay(WashBay $bay)
    {
        ...
        $this->washBayType = $bay->bay_type instanceof \App\Domains\Operations\Enums\WashBayType ? $bay->bay_type->value : $bay->bay_type;
