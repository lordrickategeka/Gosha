...
class InventoryService
{
     ...
     */
    public function releaseReservationsForWorkOrder(\App\Domains\Operations\Models\WorkOrder $workOrder): void
    {
        foreach ($workOrder->items()->whereNotNull('inventory_item_id')->get() as $item) {
            ...
            try {
                $this->releaseReservation($inventoryItem, $quantity, \App\Domains\Operations\Models\WorkOrder::class, $workOrder->id, $workOrder->branch_id, "Release reservation due to quotation rejection/cancel");
            } catch (\Throwable $e) {
