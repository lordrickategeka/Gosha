...
class JobCardFormComponent extends Component
{
    ...
    public function mount($jobCard = null)
    {
        ...
        if ($jobCardId) {
            $jobCard = \App\Models\JobCard::with(['customer', 'vehicle', 'clientNarrations'])->find($jobCardId);
            if ($jobCard) {
    ...
    public function searchCustomers()
    {
        ...
        $this->customerSuggestions = \App\Models\Customer::where('customer_name', 'like', "%{$this->customer_name}%")
    ...
    {
        $customer = \App\Models\Customer::with('vehicles')->find($customerId);
        if ($customer) {
