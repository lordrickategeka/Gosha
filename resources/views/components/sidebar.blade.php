<aside class="w-64 bg-base-100 border-r border-gray-200 min-h-screen">
    <nav class="p-6">
        <ul class="menu space-y-2">
            ...
            <li>
                <a href="{{ route('workshop-jobcards.index') }}"
                   class="flex items-center gap-3 {{ request()->routeIs('workshop-jobcards.*') ? 'bg-primary text-white' : 'text-black hover:bg-gray-100' }} rounded-lg">
                    <i class="fas fa-tools w-5 h-5 text-black {{ request()->routeIs('workshop-jobcards.*') ? 'text-white' : '' }}"></i>
                    <span>Workshop Jobcards</span>
                </a>
            </li>
            <li>
                <a href="{{ route('vehicles.all') }}"
                   class="flex items-center gap-3 {{ request()->routeIs('vehicles.*') ? 'bg-primary text-white' : 'text-black hover:bg-gray-100' }} rounded-lg">
                    <i class="fas fa-car-side w-5 h-5 text-black {{ request()->routeIs('vehicles.*') ? 'text-white' : '' }}"></i>
                    <span>Vehicles</span>
                </a>
            </li>
        </ul>
