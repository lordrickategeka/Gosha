<div>
    <div class="flex items-center gap-4 mb-6">
        ...
        <div>
            ...
            <p class="text-base-content/60">Create a new part or supply</p>
        </div>
    </div>
        ...
        <div class="card bg-base-100 shadow-sm">
            <div class="card-body">
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div class="form-control">
                        <label class="label"><span class="label-text font-medium">Initial Quantity</span></label>
                        <input type="number" wire:model="quantity" class="input input-bordered" min="0" />
                    ...
                    <div class="form-control">
                        ...
                        @error('reorder_level') <span class="label-text-alt text-error">{{ $message }}</span> @enderror
                    </div>
                    <div class="form-control">
                        ...
                        @error('cost_price') <span class="label-text-alt text-error">{{ $message }}</span> @enderror
                    </div>
                    <div class="form-control">
                        ...
                        @error('selling_price') <span class="label-text-alt text-error">{{ $message }}</span> @enderror
                    </div>
                    <div class="form-control">
