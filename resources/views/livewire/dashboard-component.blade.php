                ...
                <div class="card-body p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <h3 class="text-3xl font-bold text-black mt-1">$18,742</h3>
                ...
                <div class="card-body p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <h3 class="text-3xl font-bold text-black mt-1">47</h3>
                            <p class="text-sm text-gray-500 mt-1">
                ...
                <div class="card-body p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <h3 class="text-3xl font-bold text-black mt-1">124</h3>
                            <p class="text-sm text-gray-500 mt-1">
                ...
                <div class="card-body p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <h3 class="text-3xl font-bold text-black mt-1">4.8/5</h3>
                            <p class="text-sm text-gray-500 mt-1">
                                Based on 89 reviews
                            </p>
                        </div>
            ...
            <div class="card bg-base-100 shadow-md rounded-lg border border-gray-200">
                ...
                <div class="p-6">
                    <div class="space-y-4">
                        ...
                        <div
                            class="flex items-center space-x-4 p-3 border-l-4 border-secondary bg-gray-50 rounded-r-lg">
                            <div class="text-center">
                        ...
                        <div
                            class="flex items-center space-x-4 p-3 border-l-4 border-gray-300 bg-gray-50 rounded-r-lg">
                            <div class="text-center">
                        ...
                        <div
                            class="flex items-center space-x-4 p-3 border-l-4 border-gray-200 bg-gray-50 rounded-r-lg">
                            <div class="text-center">
