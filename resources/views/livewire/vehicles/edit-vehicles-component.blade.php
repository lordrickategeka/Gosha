<div class="gh-page">
    <div style="display:flex; align-items:center; gap:14px;">
        <a href="{{ route('vehicles.show', $vehicle) }}" class="gh-btn gh-btn--sm">←</a>
        <div>
            <div style="font-size:21px; font-weight:700; letter-spacing:-0.02em;">Edit Vehicle</div>
            <p class="gh-muted" style="font-size:12.5px; margin-top:2px;">{{ $vehicle->registration_number }}</p>
        </div>
    </div>
    ...
    <form wire:submit="save" style="max-width:56rem; display:flex; flex-direction:column; gap:16px;">
        ...
        <div class="gh-card gh-card--pad">
            ...
            @if($customer_id)
                <input type="text" value="{{ $customerSearch }}" class="gh-input" style="width:100%; max-width:28rem; background:var(--gh-base-200);" readonly>
            @else
        ...
        <div class="gh-card gh-card--pad">
            ...
            <div class="gh-grid-2">
                <div class="gh-field">
                    ...
                    <input type="text" wire:model="registration_number" class="gh-input" style="width:100%; text-transform:uppercase;">
                ...
                <div class="gh-field">
                    ...
                    <input type="text" wire:model="make" class="gh-input" style="width:100%;">
                </div>
                <div class="gh-field">
                    <span class="gh-label">Model</span>
                    <input type="text" wire:model="model" class="gh-input" style="width:100%;">
                </div>
                <div class="gh-field">
                    <span class="gh-label">Year</span>
                    <input type="number" wire:model="year" class="gh-input" style="width:100%;" min="1900" max="2035">
                </div>
                <div class="gh-field">
                    <span class="gh-label">Color</span>
                    <input type="text" wire:model="color" class="gh-input" style="width:100%;">
                </div>
            </div>
        </div>
        ...
        <div class="gh-card gh-card--pad">
            ...
            <div class="gh-grid-2">
                <div class="gh-field">
                    ...
                    <input type="text" wire:model="vin" class="gh-input" style="width:100%; text-transform:uppercase;" maxlength="17">
                </div>
                <div class="gh-field">
                ...
                <div class="gh-field">
                    ...
                    <input type="text" wire:model="engine_code" class="gh-input" style="width:100%; text-transform:uppercase;">
                </div>
                <div class="gh-field">
                    <span class="gh-label">Displacement (L)</span>
                    <input type="number" step="0.1" wire:model="engine_displacement" class="gh-input" style="width:100%;" min="0" max="10">
                </div>
                <div class="gh-field">
                ...
                <div class="gh-field">
                    ...
                    <input type="number" wire:model="mileage" class="gh-input" style="width:100%;" min="0">
                </div>
            </div>
        </div>
        ...
        <div style="display:flex; justify-content:flex-end; gap:8px;">
            <a href="{{ route('vehicles.show', $vehicle) }}" class="gh-btn">Cancel</a>
