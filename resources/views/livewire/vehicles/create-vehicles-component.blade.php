                ...
                <table class="w-full">
                    <tbody class="divide-y divide-gray-200">
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-3">
                                <input type="text" wire:model="model" class="input input-bordered" placeholder="Hilux" />
                            </td>
                        </tr>
                        <tr>
                            <td class="px-6 py-3 text-sm font-medium text-gray-500">Year</td>
                            <td class="px-6 py-3">
                                <input type="number" wire:model="year" class="input input-bordered" placeholder="2024" min="1900" max="2035" />
                            </td>
                ...
                <table class="w-full">
                    <tbody class="divide-y divide-gray-200">
                        <tr>
                            ...
                            <td class="px-6 py-3">
                                <input type="text" wire:model="vin" class="input input-bordered uppercase" placeholder="1HGBH41JXMKN10986" maxlength="17" />
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-3">
                                <input type="text" wire:model="engine_code" class="input input-bordered uppercase" placeholder="2GD-FTV" />
                            </td>
                            <td class="px-6 py-3 text-sm font-medium text-gray-500">Displacement (L)</td>
                            <td class="px-6 py-3">
                                <input type="number" step="0.1" wire:model="engine_displacement" class="input input-bordered" placeholder="2.0" min="0" max="10" />
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="px-6 py-3">
                                <input type="number" wire:model="mileage" class="input input-bordered" placeholder="0" min="0" />
                            </td>
                        </tr>
                    </tbody>
                </table>
