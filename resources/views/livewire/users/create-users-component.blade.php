<div>
    <div class="flex items-center gap-4 mb-6">
        ...
        <div>
            ...
            <p class="text-base-content/60">Create a new team member</p>
        </div>
    </div>
            ...
            <div class="card-body">
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div class="form-control sm:col-span-2">
                        ...
                        <span class="label-text-alt text-base-content/60">Leave empty to allow access to all branches</span>
                    </div>
                </div>
