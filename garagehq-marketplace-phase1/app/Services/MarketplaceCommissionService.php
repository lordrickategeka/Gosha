 ...
 *
 * INTEGRATION POINT: the existing platform BillingService owns plan/rate resolution and
 * invoicing. This class isolates that dependency so the rest of the marketplace never calls
 * BillingService directly. Wire the two TODOs below to your BillingService API; until then it
