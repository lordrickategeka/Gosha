...
class Browse extends Component
{
    ...
    private function buyerVendorId(): int
    {
    ...
    public function buy(int $listingId, int $qty = 1): void
    {
        ...
        $po = app(PurchaseOrderService::class)->createFromListing(
            listing: $listing,
            qty: $qty,
            buyerVendorId: $this->buyerVendorId(),
    ...
    public function render()
    {
        $listings = MarketplaceListing::browsable()
            ...
            ->orderByDesc(
                \App\Models\Vendor::select('is_verified_supplier')
        ...
        return view('livewire.marketplace.browse', compact('listings', 'focusProduct'));
    }
}
